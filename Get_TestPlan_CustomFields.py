...
# JQL Query
JQL_QUERY = 'issuetype = "Test Plan"'

# Custom Field IDs
CUSTOM_FIELDS = {
    'Requirement': 'customfield_15424',
    'TP Progress': 'customfield_15418',
    'TP Status': 'customfield_15419',
    'Number of Steps': 'customfield_15427',
    'Number of Test Cases': 'customfield_15428',
    'Origins': 'customfield_11401'
}

# Output CSV file
OUTPUT_FILE = f"testplan_custom_fields_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
        ...
        with open(OUTPUT_FILE, 'w', newline='', encoding='utf-8') as csvfile:
            ...
            for issue in issues:
                ...
                row = [
                    ...
                    extract_field_value(fields.get(CUSTOM_FIELDS['TP Progress'])),
                    extract_field_value(fields.get(CUSTOM_FIELDS['TP Status'])),
                    extract_field_value(fields.get(CUSTOM_FIELDS['Number of Steps'])),
                    extract_field_value(fields.get(CUSTOM_FIELDS['Number of Test Cases'])),
                    extract_field_value(fields.get(CUSTOM_FIELDS['Origins']))
                ]
