...
CSV_FILE = "import_steps.csv"  # CSV with Test Key, Step No, Action, Input, Expected Result
OUTPUT_CSV = "import_steps_results.csv"
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('import_steps_execution.log'),
